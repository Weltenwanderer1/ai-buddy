              ...
              child: Column(
                ...
                children: [
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isSelected ? null : context.buddy.card.withValues(alpha: 0.6),
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                              color: isSelected
                                  ? Colors.transparent
                                  : context.buddy.border.withValues(alpha: 0.3),
                              width: 1,
                            ),
                          ),
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.w600,
                              color: isSelected ? Colors.white : context.buddy.t2,
                            ),
                          ),
                        ),
                      );
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: context.buddy.elev.withValues(alpha: 0.5),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: hint,
          hintStyle: TextStyle(
            color: context.buddy.t3.withValues(alpha: 0.6),
            fontSize: 15,
            fontWeight: FontWeight.w500,
          ),
