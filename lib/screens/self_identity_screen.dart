...
class _SelfIdentityScreenState extends State<SelfIdentityScreen> {
        ...
        builder: (context, self, _) {
          return CustomScrollView(
            ...
            slivers: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: context.buddy.border.withValues(alpha: 0.3),
                                  ),
                                ),
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: EdgeInsets.fromLTRB(16, 0, 16, MediaQuery.paddingOf(context).bottom + 40),
                  child: Column(
                            ...
                            children: self.keyExperiences.map((e) => Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(
                                    color: context.buddy.border.withValues(alpha: 0.2),
                                  ),
                                ),
  ...
  Widget _buildCard({required String title, required IconData icon, required Widget child}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: context.buddy.card.withValues(alpha: 0.7),
  ...
  Widget _buildTextField(TextEditingController ctl, {int maxLines = 1}) {
    return TextField(
      controller: ctl,
      maxLines: maxLines,
      style: TextStyle(color: context.buddy.t1, fontSize: 14),
      decoration: InputDecoration(
        hintStyle: TextStyle(color: context.buddy.t3.withValues(alpha: 0.5)),
        filled: true,
        fillColor: context.buddy.card.withValues(alpha: 0.4),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: context.buddy.border.withValues(alpha: 0.3)),
        ),
